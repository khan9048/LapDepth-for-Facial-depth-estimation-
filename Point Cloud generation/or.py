...
# Load images
rgb = cv2.cvtColor(cv2.imread('my_examples/test2_new.jpg'), cv2.COLOR_BGR2RGB)

# Depth is stored as float32 in meters
depth = cv2.imread('out_my_examples/out_my_examples/test2_new.exr', cv2.IMREAD_ANYDEPTH)
