...
# Load images
rgb = cv2.cvtColor(cv2.imread(r"my_examples_1/13.jpg"), cv2.COLOR_BGR2RGB)

# Depth is stored as float32 in meters
depth = cv2.imread(r"output/13.exr", cv2.IMREAD_ANYDEPTH)
# depth = cv2.imread('data/depthExr0019.exr', cv2.IMREAD_ANYDEPTH)
# depth = cv2.imread('data/sync_depth_00045.exr', cv2.IMREAD_ANYDEPTH)
