...
parser.add_argument('--model_dir', type=str,
                    default='NYU_LDRN_ResNext101_epoch35_synthe_org/epoch_25_loss_3.2482_1.pkl')
...
parser.add_argument('--testfile_nyu', type=str, default="data_test1.txt")
parser.add_argument('--data_path', type=str,default="D:\project1\dataCreation\Data\Data\data_exr_base_01\wholeFaceDepth")
...
parser.add_argument('--max_depth', default=150.0, type=float, metavar='MaxVal', help='max value of depth')
parser.add_argument('--lv6', action='store_true', help='use lv6 Laplacian decoder')

# Evaluation setting
parser.add_argument('--evaluate', action='store_true', help='evaluate score', default=False)
parser.add_argument('--multi_test', action='store_true', help='test all of model in the dir')
parser.add_argument('--img_save', action='store_true', help='will save test set image', default=True)
...
parser.add_argument('--gpu_num', type=str, default="0,1", help='force available gpu index')
...
def main():
    ...
    if args.img_save is True:
        ...
        for idx, (rgb_data, gt_data, gt_dense, filename) in enumerate(val_loader):
            # if gt_data.ndim != 4 and gt_data[0] == True:
            #     continue
