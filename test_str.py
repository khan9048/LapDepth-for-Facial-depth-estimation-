...
parser.add_argument('--img_folder_dir', type=str, default='my_examples_1')
...
parser.add_argument('--max_depth', default=36000.0, type=float, metavar='MaxVal', help='max value of depth')
...
for i, img_file in enumerate(img_list):
    ...
    plt.imsave(result_filename, np.log10(out), cmap='Greys')
    if (i + 1) % 10 == 0:
